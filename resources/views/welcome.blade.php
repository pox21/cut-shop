                ...
                <div class="header-inner flex items-center justify-between lg:justify-start">
                    <div class="header-logo shrink-0">
                        <a href="index.html" rel="home">
                            <img src="{{ Vite::asset('resources/images/logo.svg') }}" class="w-[120px] xs:w-[148px] md:w-[201px] h-[30px] xs:h-[36px] md:h-[50px]" alt="CutCode">
                        </a>
                    </div><!-- /.header-logo -->
                    ...
                    <div class="header-actions flex items-center gap-3 md:gap-5">
                        ...
                        <div x-data="{dropdownProfile: false}" class="profile relative">
                            <button @click="dropdownProfile = ! dropdownProfile" class="flex items-center text-white hover:text-pink transition">
                                ...
                                <img src="{{ Vite::asset('resources/images/avatar.jpg') }}" class="shrink-0 w-7 md:w-9 h-7 md:h-9 rounded-full" alt="Данил Шуцкий">
                            ...
                            >
                                ...
                                <div class="flex items-center mt-3">
                                    <img src="{{ Vite::asset('resources/images/avatar.jpg') }}" class="w-11 h-11 rounded-full" alt="Данил Шуцкий">
